...
def test_frontend_is_served_from_the_inference_service(settings):
    ...
    assert b"Open a real USPTO patent" in script.data
    ...
    assert b"US9922200B2" in demo_record.data
    assert b"US10831913B2" in demo_record.data
    assert b"71.4%" not in script.data
